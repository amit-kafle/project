...
public class MainActivity extends AppCompatActivity {
    ...
    Button btn_1,btn_2,btn_3,btn_4,btn_5,btn_6,btn_7,btn_8,btn_9,btn_0,btn_Add,btn_Sub,btn_Mul,btn_Div,btn_eql,btn_dec,btn_clear, exit;
    TextView ed1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_Div = (Button) findViewById(R.id.btndivide);
        btn_Sub = (Button) findViewById(R.id.btnsubtract);
        btn_Mul = (Button) findViewById(R.id.btnmultiply);
        btn_eql = (Button) findViewById(R.id.btnequal);
        btn_dec = (Button) findViewById(R.id.btndeci);
        btn_clear = (Button) findViewById(R.id.btnclear);
        ed1 = (TextView) findViewById(R.id.Input);
